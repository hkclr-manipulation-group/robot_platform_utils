...
void mergeDiscoveredServerEntry(
    ...
    existing.protocol_major = incoming.protocol_major;
    existing.protocol_minor = incoming.protocol_minor;
    existing.protocol_capabilities = incoming.protocol_capabilities;
